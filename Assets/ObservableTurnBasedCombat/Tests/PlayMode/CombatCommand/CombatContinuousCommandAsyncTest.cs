...
namespace ObservableTurnBasedCombat.Tests.PlayMode
{
    ...
    public class CombatContinuousCommandAsyncTests
    {
        [Test]
        public void SetAdditionalCommand_AddCommand_Success()
        {
            ...
            var combatContinuousCommandAsync = new CombatContinuousCommandAsync(combatCommandAsync);
        ...
        public void SetAdditionalCommand_AddCommandToInstanceHavingAdditionalCommand_AddtionalCommandHasAdditionalCommand()
        {
            ...
            var combatContinuousCommandAsync = new CombatContinuousCommandAsync
            (
                combatCommandAsync,
                combatCommandAsync
            );
